...
export default function Signup() {
  ...
  return (
    <div className='max-w-screen w-full flex-col h-screen flex items-center justify-center  bg-linear-to-b from-[#061021] via-[#071428] to-[#08122a] relative overflow-hidden'>
